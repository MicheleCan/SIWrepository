...
//	- Aggiungere l'entita' CORSO(codice, nome), molti a molti con Studente.
	...
	public static void main(String args[]) {
		...
		Indirizzo indirizzo1 = new Indirizzo((long) 1,"Via...");
		...
		studente3.setIndirizzo(indirizzo1);
		...
		System.out.println(indirizzoDao.findByPrimaryKey((long) 1));
		...
		System.out.println("Retrieve all gruppo: proxy all'opera");
		for(Gruppo g : gruppoDao.findAllJoin()) {
			System.out.println(g);
		}
		
		System.out.println("FIND GROUP primary key");
		System.out.println(gruppoDao.findByPrimaryKeyJoin((long) 1).getNome() );
